...
/*
    ...
    */
    ...
    public struct Palette {
        ...
        public static let greenFill = NSColor(calibratedRed: 0.7, green: 0.8, blue: 0.7, alpha: 1.0)
        public static let greenOutline = NSColor(calibratedRed: 0.1, green: 0.8, blue: 0.1, alpha: 1.0)
        
        public static let redFill =  NSColor(calibratedRed: 1.0, green: 0.1, blue: 0.1, alpha: 0.08)
        ...
        public static let blueOutline = NSColor(calibratedRed: 0.1, green: 0.1, blue: 1.0, alpha: 1.0)
    }
}