//
//  LeftAlignedSequenceFlowLayout.swift
//  Filament
//
...
class LeftAlignedSequenceFlowLayout: NSCollectionViewFlowLayout {
    
    var maximumCellSpacing = CGFloat(0.0)
